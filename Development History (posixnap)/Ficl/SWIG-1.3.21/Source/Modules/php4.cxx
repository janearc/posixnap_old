...
char cvsroot_php4_cxx[] = "$Header: /home/jabba/convert/cvs/Ficl/SWIG-1.3.21/Source/Modules/php4.cxx,v 1.1 2004-02-01 04:05:28 alex Exp $";
...
public:
  ...
  void create_extra_files(String *outfile) {
	...
	SWIG_exit(EXIT_FAILURE);
      ...
      Printf(f_extra,
	     "# $Id: php4.cxx,v 1.1 2004-02-01 04:05:28 alex Exp $\n\n"
	...
	SWIG_exit(EXIT_FAILURE);
      ...
      Printf(f_extra,
	     "dnl $Id: php4.cxx,v 1.1 2004-02-01 04:05:28 alex Exp $\n"
	     "dnl ***********************************************************************\n"
