package Neopets::Neopia::Tyrannia::WheelOfMediocrity;
...
Neopets::Neopia::Tyrannia::WheelOfMediocrity - Wheel of Mediocrity interface
...
=head1 SYNOPSIS
  ...
  my $wheel = Neopets::Neopia::Tyrannia::WheelOfMediocrity -> new(
    { agent => \$agent } );
...
This module allows the the manipulation of the Neopets Wheel
of Excitement found in Tyrannia.  It has only one method:
spin() which is prety self explanatory.
...
=item $wheel = Neopets::Neopia::Tyrannia::WheelOfMediocrity->new;

This constructr takes hash arguments and
...
sub spin {
  ...
  return common_spin(
    ...
    'http://www.neopets.com/prehistoric/mediocrity2.phtml',
    'http://www.neopets.com/prehistoric/mediocrity3.phtml'
  );
}
