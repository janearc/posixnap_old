...
Mancala::AI::Minimalist - A Mancala AI
...
=head1 SYNOPSIS
 ...
 my $player = Mancala::Player::Machine -> new(
    'AI' => 'Mancala::AI::Minimalist' );

=head1 ABSTRACT

This Mancala AI is similar to L<Mancala::AI::FencedIn|Mancala::AI::FencedIn>.  It however chooses the move giving itself the least number of possible moves, complicating the opponent's trip around the board.
...
sub _generate_tree {
    ...
    foreach my $move_index ( 0 .. @possible_moves-1 ) {
        ...
        if ( $next_move ) {
            ...
            $opp_moves = scalar @{ $player -> traverser() -> valid_cups( $player, $new_board ) };
        }
